...
@Composable
fun QuizzesScreen(authManager: AuthManager, onOpenQuiz: (String, Boolean) -> Unit, onCreateQuiz: () -> Unit, onBack: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.quizzes_heading)) },
